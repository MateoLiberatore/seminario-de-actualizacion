export class ApplicationModel
{
    ...
    _saveAuthData()
    {
        localStorage.setItem('authData', JSON.stringify(Array.from(this.authData.entries())));
    }
    ...
    {
        let usedIds = Object.keys(this.productData).map(function(id) { return parseInt(id); }).sort(function(a, b) { return a - b; });
        let nextId = 1;
